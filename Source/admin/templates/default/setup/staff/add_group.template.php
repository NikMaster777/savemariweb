    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <input type="text" name="group_name" value="<?php echo lib::post('group_name',false,true,true); ?>" placeholder="" class="form-control">
            </div> 
            
            <div class="form-group">
            	<label>Group Description:</label>
                <input type="text" name="group_description" value="<?php echo lib::post('group_description',false,true,true); ?>" placeholder="" class="form-control">
            </div>
            ...
            <div class="form-group">
            	<input type="submit" class="btn btn-default" value="Add Group" name="_submit">
            </div>
