...
function acf_height_filter( $props, $name, $location ) {
	
	if( isset( $props['format'] ) && $props['format'] == 'height' && is_numeric( $props['value'] ) ) {
		$feet = floor( $props['value'] / 12 );
		$inches = $props['value'] % 12;
		$props['value'] = $feet . '\'' . $inches . '"';
	}
