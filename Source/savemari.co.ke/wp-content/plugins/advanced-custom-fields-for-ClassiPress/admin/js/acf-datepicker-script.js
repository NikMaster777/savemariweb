jQuery(document).ready(function($) {
    ...
    function dateOptConstr() {
		...
		dateOptions.buttonText = "";
		dateOptions.buttonImage = ($("#icon_trigger").attr("checked") === "checked" && typeof buttonImage != 'undefined') ? buttonImage : "";
        dateOptions.buttonImageOnly = ($("#icon_trigger").attr("checked") === "checked" && typeof buttonImage != 'undefined') ? true : false;
