						...
						<div id="single_images" class="shadowblock_out <?php cp_display_style( 'featured' ); ?>">
							...
							<div class="shadowblock">
									...
									<div id="single_images" class="bigleft">
										...
										<div class="bigimg">
											<?php if (in_array($post->ID, get_option('sticky_posts'))) { ?>
												<span class="ftm_featured"><?php _e('Featured', CPSR_TD); ?></span>
											<?php } ?>
											<?php if ( get_post_meta( $post->ID, 'cp_ad_sold', true ) == 'yes' ) : ?>
												<span class="ftm_sold"><?php _e('Sold', CPSR_TD); ?></span>
											<?php endif; ?>
											<?php if (get_post_meta($post->ID, 'cp_ad_pick', true) == 'yes') : ?>
												<span class="ftm_pick"><?php _e('Sale Pending', CPSR_TD); ?></span>
											<?php endif; ?>
								...
								<div class="bigright <?php cp_display_style( 'ad_single_images' ); ?>">
									...
									<p><div class="emailico"></div><a href="mailto:?subject=<?php the_title(); ?>&amp;body=<?php _e( 'Thought you might like this:', CPSR_TD ); ?> <?php the_permalink(); ?>" title="Opens your email client"><div><?php _e( 'Email to a friend', CPSR_TD ); ?></div></a></p>
								...
								<?php appthemes_before_post_content(); ?>
									...
									<div class="ftm-author">
										<span class="author"><?php if ( get_option('cp_ad_gravatar_thumb') == 'yes' ) appthemes_get_profile_pic( get_the_author_meta('ID'), get_the_author_meta('user_email'), 16 ); ?><?php _e('Item listed by:', CPSR_TD); ?> <?php the_author_posts_link(); ?></span>
								...
								<nav id="nav-single">
									<?php if (function_exists( 'ftm_vienna_mod' )) { ftm_vienna_mod($post->ID); } ?>
								</nav>
