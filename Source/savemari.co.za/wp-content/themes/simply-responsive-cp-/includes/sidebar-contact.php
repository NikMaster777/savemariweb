...
if ( isset( $_POST['submit'] ) && $_POST['send_email'] == 'yes' ) {
	...
	if ( $result->get_error_code() ) {
		...
		$msg = '<p class="sent center"><strong>' . __( 'Your message has been sent!', CPSR_TD ) . '</strong></p>';
	}
...
?>
   ...
   <form name="mainform" id="mainform" class="form_contact" action="#priceblock2" method="post" enctype="multipart/form-data">
       ...
       <p class="contact_msg"><?php _e( 'To inquire about this ad listing, complete the form below to send a message to the ad poster.', CPSR_TD ); ?></p>
