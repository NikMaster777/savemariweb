			...
			<div class="content_left">
				...
				<div class="tabcontrol">
					...
					<ul class="tabnavig">
						...
						<li><a href="#block2"><span class="big"><?php _e( 'Popular', CPSR_TD ); ?></span></a></li>
						<li><a href="#block3"><span class="big"><?php _e( 'Random', CPSR_TD ); ?></span></a></li>
						<li><a href="#block4"><span class="big"><?php _e( 'Featured', CPSR_TD )?></span></a></li>
					</ul>
					...
					<div id="block1">
						...
						<?php
							if ( $total_pages > 1 ) {
						?>
								<div class="paging"><a href="<?php echo $post_type_url; ?>"> <?php _e( 'View More Ads', CPSR_TD ); ?> </a></div>
						<?php } ?>
					...
					<div id="block2">
						...
						?>
								<div class="paging"><a href="<?php echo $popular_url; ?>"> <?php _e( 'View More Ads', CPSR_TD ); ?> </a></div>
						<?php } ?>
					...
					<div id="block3">
						...
						?>
								<div class="paging"><a href="<?php echo $random_url; ?>"> <?php _e( 'View More Ads', CPSR_TD ); ?> </a></div>
						<?php } ?>
