...
<div class="content_right">
	...
	<div class="shadowblock_out">
		...
		<div class="shadowblock">
			...
			<h2 class="dotted"><?php _e( 'User Options', CPSR_TD ); ?></h2>
			...
			<?php if ( has_nav_menu( 'theme_dashboard' ) ) : wp_nav_menu( array( 'theme_location' => 'theme_dashboard', 'menu_id' => 'menu-dashboard', 'container' => false ) ); else : ?>
				...
				<ul>
					<li><a href="<?php echo CP_DASHBOARD_URL; ?>"><?php _e( 'My Dashboard', CPSR_TD ); ?></a></li>
		...
		<div class="shadowblock">
			...
			<div class="avatar"><?php appthemes_get_profile_pic( $current_user->ID, $current_user->user_email, 60 ); ?></div>
				...
				<ul class="user-details">
					...
					<?php if ( ! empty( $current_user->twitter_id ) ) { ?><li><div class="twitterico"></div><a href="http://twitter.com/<?php echo esc_attr( $current_user->twitter_id ); ?>" target="_blank"><?php _e( 'Twitter', CPSR_TD ); ?></a></li><?php } ?>
					<?php if ( ! empty( $current_user->facebook_id ) ) { ?><li><div class="facebookico"></div><a href="<?php echo appthemes_make_fb_profile_url( $current_user->facebook_id ); ?>" target="_blank"><?php _e( 'Facebook', CPSR_TD ); ?></a></li><?php } ?>
