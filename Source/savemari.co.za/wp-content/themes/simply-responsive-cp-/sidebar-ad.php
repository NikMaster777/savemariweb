...
<div class="content_right">
	...
	<div class="tabprice">
		...
		<div id="priceblock2">
			...
			?>
				<div class="pad25"></div>
				<p class="contact_msg center"><strong><?php _e( 'You must be logged in to inquire about this ad.', CPSR_TD ); ?></strong></p>
		...
		<div id="priceblock3">
			...
			<div class="postertab">
				...
				<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" class="btn"><span><?php _e( 'Latest items listed by', CPSR_TD ); ?> <?php the_author_meta( 'display_name' ); ?> &raquo;</span></a>
