							...
							<ol>
								...
								<span class="form-fields">
									...
									<li>
										...
										<div class="ad-static-field"><strong><?php echo cp_get_category_parents($category->term_id); ?></strong>&nbsp;&nbsp;<small><a href="<?php echo $select_category_url; ?>"><?php _e( '(change)', APP_TD ); ?></a></small></div>
									</li>
