		...
		<div class="footer_main">
				...
				<div class="footer_main_res">
						...
						<?php if ( $cp_options->twitter_username ) : ?>
								<a href="http://twitter.com/<?php echo $cp_options->twitter_username; ?>" class="dashicons-before twit" target="_blank" title="<?php esc_attr_e( 'Twitter', APP_TD ); ?>"></a>
						<?php endif; ?>

						<div class="right">
								<p><a href="http://www.savemari.com" target="_blank" rel="nofollow">Saving you Money</a> - <?php _e( 'Powered by', APP_TD ); ?> <a href="https://wordpress.org/" target="_blank" rel="nofollow">WordPress</a></p>
						</div>
